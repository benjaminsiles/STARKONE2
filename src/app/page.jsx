    ...
    >
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-6 w-full pb-24 pt-48">
        ...
        >
          S.T.A.R.K. {" "}
          <br />
          <span style={{ color: ON_BRAND }}>ONE.</span>
        </h1>
...
function CatalogPanel({
  ...
  return (
    <section
      id={id}
      ref={ref}
      className={`catalog-panel border-b border-white/15${visible ? " is-visible" : ""}`}
    >
      <div className="max-w-7xl mx-auto px-6 py-28 md:py-36 grid md:grid-cols-2 gap-0 items-stretch">
        <div
          className={`flex flex-col justify-between pb-12 md:pb-0 border-b md:border-b-0 border-white/15 ${
        ...
        >
          ...
          <div className="mt-12">
            <a
              href="#connect"
              className="inline-flex items-center gap-3 text-white text-xs font-black uppercase group border-b border-white/40 pb-2 hover:border-white transition-colors"
              style={{ letterSpacing: "0.15em" }}
            >
  ...
  return (
    <div className="space-y-6">
      {items.map((item) => (
        <div
          key={item.num}
          className="flex gap-6 p-6 bg-white/10 border border-white/20 hover:border-white/40 transition-colors"
        >
          <span
            className="text-[10px] font-black text-white/65 mt-1 shrink-0"
    ...
    <div>
      ...
      <div className="grid grid-cols-2 gap-4">
        {[
          ...
          <div key={s.stat} className="bg-white/10 border border-white/20 p-6">
            <p
            ...
            <p
              className="text-white/80 text-xs leading-relaxed font-light uppercase"
              style={{ letterSpacing: "0.08em" }}
            >
              {s.label}
            </p>
  ...
  return (
    <div className="border border-white/15">
      {pillars.map((p, i) => (
        <div
          key={i}
          className="flex gap-6 items-start p-8 border-b border-white/15 last:border-b-0 hover:bg-white/10 transition-colors group cursor-pointer"
        >
          <div className="shrink-0 w-10 h-10 border border-white/40 flex items-center justify-center text-white group-hover:border-white group-hover:bg-white/15 group-hover:text-white transition-colors">
            {p.icon}
          </div>
          ...
          <ChevronRight
            size={14}
            className="text-white/50 group-hover:text-white transition-colors mt-1 shrink-0"
          />
        </div>
      ))}
    </div>
...
function EventsSection() {
  return (
    <section id="events" className="border-b border-white/15">
      <div className="max-w-7xl mx-auto px-6 py-28 md:py-36">
        <div className="flex items-end justify-between mb-16 border-b border-white/15 pb-8">
        ...
        <div>
          {events.map((ev, i) => (
            <div
              key={i}
              className="group flex flex-col md:flex-row md:items-center gap-6 md:gap-12 py-10 border-b border-white/15 hover:bg-white/10 transition-colors px-2"
            >
              ...
              <div className="hidden md:block w-px h-12 bg-white/15 shrink-0" />
              ...
              <div className="flex-1">
                ...
                <h4
                  className="text-xl md:text-2xl font-light text-white mb-2 group-hover:text-white transition-colors"
                  style={{
                    fontFamily:
                      "'Le Jour Serif', 'Playfair Display', Georgia, serif",
                  }}
                ...
                <div
                  className="flex items-center gap-6 text-white/75 text-xs font-medium uppercase"
                  style={{ letterSpacing: "0.1em" }}
                >
              ...
              <a
                ...
                className="square-btn shrink-0 bg-white text-brand font-black px-7 py-3 text-xs uppercase opacity-0 group-hover:opacity-100 transition-opacity hover:bg-white/90"
                style={{ letterSpacing: "0.15em" }}
              >
                Register
              </a>
        ...
        <div className="mt-12 flex justify-end">
          <a
            href="/events/"
            className="inline-flex items-center gap-3 text-white/70 hover:text-white text-xs font-black uppercase transition-colors border-b border-white/40 pb-1 hover:border-white"
            style={{ letterSpacing: "0.15em" }}
          >
...
function CTASection() {
  return (
    <section id="connect" className="bg-brand border-t border-white/15">
        ...
        <div className="grid md:grid-cols-2 gap-16 items-center">
          <div>
            <FlickerText
              text="STAY CONNECTED"
              tag="p"
              className="text-[10px] font-black text-white uppercase mb-8 flicker-label-dark"
              style={{ letterSpacing: "0.4em" }}
            />
            <h2
              className="text-5xl md:text-7xl font-light text-white leading-[1.0] mb-8"
              style={{
                fontFamily:
                  "'Le Jour Serif', 'Playfair Display', Georgia, serif",
              }}
          ...
          <div className="flex justify-start">
            <a
              ...
              target="_blank"
              rel="noopener noreferrer"
              className="square-btn square-btn-dark bg-white text-brand font-black py-4 px-8 hover:bg-white/90 uppercase text-xs flex items-center justify-center gap-3"
              style={{ letterSpacing: "0.15em" }}
            >
