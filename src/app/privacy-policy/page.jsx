          ...
          <main className="pt-32 pb-20 px-6">
            <div className="max-w-3xl mx-auto">
              ...
              <div className="prose max-w-none text-white/85">
                ...
                <h3 className="text-lg font-bold text-white mb-4 uppercase" style={{ letterSpacing: "0.1em" }}>
                ...
                <h3 className="text-lg font-bold text-white mb-4 uppercase mt-8" style={{ letterSpacing: "0.1em" }}>
